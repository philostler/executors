=Executors has been DEPRECATED and is no longer actively developed or maintained. Take a look at Alloy[https://github.com/philostler/alloy] which integrates Java's Executor framework via a fluent interface.
