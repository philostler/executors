...
class ServicesTest < Test::Unit::TestCase
  ...
  def test_add
    ...
    assert_equal "id must be of type String or Symbol", exception.message
    ...
    assert_equal "executor must be of type Executor", exception.message
    ...
    assert_equal "executor instance has already been added against id \"id\". Duplicates not allowed", exception.message
  end
  ...
  def test_shutdown
    ...
    assert_equal "units must be of value \"nanoseconds\", \"microseconds\", \"milliseconds\", \"seconds\", \"minutes\", \"hours\" or \"days\"", exception.message
  end
